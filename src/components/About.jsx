      ...
      <div className="section-content">
        ...
        <div className="about-grid">
          <div className="about-copy reveal">
            <p className="diary-line">在荒芜里种花，<br />是我认识世界的方式。</p>
            <p>
            ...
            <div className="about-likes">
              <span className="likes-label">常做的事</span>
              <div className="tags">
                <span className="tag">UX 设计</span>
                <span className="tag">AI 工作流</span>
                <span className="tag">胡思乱想</span>
                <span className="tag">终身学习</span>
              </div>
            </div>
            <div className="about-likes">
              <span className="likes-label">随手的工具</span>
              <div className="skills-row">
                <span className="skill">Figma</span>
                <span className="skill">Cursor</span>
                <span className="skill">Codex</span>
                <span className="skill">Photoshop</span>
                <span className="skill">AI 辅助设计</span>
              </div>
            </div>
          </div>
